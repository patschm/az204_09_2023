...
namespace TopicClient
{
    class Program
    {
        ...
        static (string Name, string Key) SasKeyManager = ("Manager", "bDFD1IPejKnn057Gx3WQEmKMLcNUt37SK+ASbNTuVH8=");
        static (string Name, string Key) SasKeyWriter = ("Schrijvert", "C5sGJ8bT66o6JmhZywMr6BpDN1uRqiLCf+ASbIbccT8=");
